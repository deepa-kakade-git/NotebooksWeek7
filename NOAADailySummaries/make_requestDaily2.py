...
url = "https://www.ncdc.noaa.gov/cdo-web/api/v2?datasetid=GHCND&locationid=FIPS:10003&startdate=2018-01-01 &enddate=2018-01-31 &offset=1001#data"
...
if response.status == 200:
    ...
    for i , jobj1 in enumerate(data):
        filename = f"daily_summaries2_FIPS10003_jan_2018_{i}.json"
